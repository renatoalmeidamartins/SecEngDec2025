...
## Labs, learning materials and tools
...
- [From the path above, there is a free 20-question practice exam](https://skillbuilder.aws/learn/N1GXANWHB1/official-practice-question-set-aws-certified--security--specialty-scsc03--english/ZM6FBMH6NB)
- [List of classroom-based training offerings from AWS](https://aws.amazon.com/training/classroom/)
- [Zoomit, the tool I use to zoom in and highlight content with arrows and rectangles](https://learn.microsoft.com/en-us/sysinternals/downloads/zoomit) 
## Day 1 links
